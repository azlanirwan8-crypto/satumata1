...
export default function ClinicManagementView({ 
  ...
  if (currentView === 'detail' && selectedClinic) {
    return <ClinicDetailView clinic={selectedClinic} onBack={() => { setCurrentView('list'); setSelectedClinic(null); }} />;
  }
                ...
                {paginatedClinics.length > 0 ? (
                  paginatedClinics.map((clinic) => (
                    <tr key={clinic.id} className="hover:bg-slate-50/50 transition-colors group">
                      <td className="px-6 py-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] font-mono text-gray-400 uppercase tracking-wider">{clinic.code}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-5">
                      ...
                      <td className="px-6 py-5 text-xs font-medium">01 Jun 25 - 01 Jun 26</td>
